...
# Create the RUNNER_CODE_TEMPLATE
template = '''
...
# Find where to inject the template
import_end = content.find("def load_state")
content = content[:import_end] + template + "\n" + content[import_end:]

# Replace the inner f-string
